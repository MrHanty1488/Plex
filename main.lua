...
return function(Config)
	...
	local isVertical = Config.SubTitlePosition == "Vertical"
	local frameHeight = isVertical and 60 or 42
	local layoutDirection = isVertical and Enum.FillDirection.Vertical or Enum.FillDirection.Horizontal
	local padding = isVertical and UDim.new(0, 2) or UDim.new(0, 5)
	local titleSize = isVertical and UDim2.fromScale(1, 0.5) or UDim2.fromScale(0, 1)
	local titleAutomaticSize = isVertical and Enum.AutomaticSize.Y or Enum.AutomaticSize.X
	local titleYAlignment = isVertical and "Top" or "Center"
	local subtitleYAlignment = isVertical and "Bottom" or "Center"
	...
	TitleBar.Frame = New("Frame", {
		...
		New("Frame", {
			...
			New("TextLabel", {
				...
				TextSize = 14,
				TextXAlignment = "Left",
				TextYAlignment = titleYAlignment,
				Size = titleSize,
				AutomaticSize = titleAutomaticSize,
				BackgroundTransparency = 1,
				ThemeTag = {
					TextColor3 = "Text",
				},
			...
			New("TextLabel", {
				...
				TextSize = 12,
				TextXAlignment = "Left",
				TextYAlignment = subtitleYAlignment,
				Size = titleSize,
				AutomaticSize = titleAutomaticSize,
				BackgroundTransparency = 1,
				ThemeTag = {
